...
class Record:
    ...
    def get_record_id(self):
        ...
        try:
            header = self.elem.find("%srecordInfo" % MODS_NS)
            record_id = header.find("%srecordIdentifier" % MODS_NS).text
            return record_id
        except:
    ...
    def get_elements(self):
        ...
        out = []
        metadata = self.elem.find("%smods" % (MODS_NS))
        if len(metadata):
    ...
    def get_xpath(self):
        ...
        out = []
        metadata = self.elem.find("mods:mods", namespaces=namespaces)
