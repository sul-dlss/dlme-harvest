...
class Record:
    ...
    def get_record_id(self):
        ...
        try:
            ...
            raise RepoInvestigatorException("Record does not have a valid Record Identifier. Check the structure of the Harvested XML (does it have an OAI header? Are the namespaces correct?) and the XML path used here to get to the identifier.")
